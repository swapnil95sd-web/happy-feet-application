...
- `SUPABASE_SERVICE_ROLE_KEY`: Supabase service role key used only by Vercel server functions for admin-only writes such as saving classes. Never expose this in frontend code.
